...
<body>   
        ...
        <div class="body" style="display: flex;flex-wrap: wrap;">     <!--for entire body-->
            ...
            <div class="login" style="flex: 50%;">
                ...
                <b>     <lable for="name">Name: <input type="text" placeholder="Organisation Name" name="name" required></lable><br><br>
                        <lable for="address"></lable>address: <input type="text" placeholder="address" name="address" required></lable><br><br>
                        <lable for="contact"></lable>contact: <input type="numeric" placeholder="contact" name="contact" required></lable><br><br>
                        <lable for="email">Email: <input type="text" placeholder="as @Username" name="username" required></lable><br><br>
                        <lable for="pass"></lable>Password: <input type="text" placeholder="Password" name="Password1" required></lable><br><br>
                        <lable for="pass"></lable>Password: <input type="text" placeholder="Confirm Password" name="Password2" required></lable><br><br>
                        <button type="submit" style="background-color:silver;width: 250px;">Sign Up</submit></b>
                        <button type="button" style="background-color:silver;float:right;width: 100px;height: 40px;"><u><a href="Homepage.php">Already User</a></u></submit>
                </form>
            </div>
        </div>
</body>
